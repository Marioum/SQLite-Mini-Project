        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (androidOs == null) {
                    ...
                    intent.putExtra("nbusers", String.valueOf(androidOs.getNbUser()));
                    intent.putExtra("nbversion", String.valueOf(androidOs.getNbVersion()));
                    intent.putExtra("nbsmart", String.valueOf(androidOs.getNbsmart()));
